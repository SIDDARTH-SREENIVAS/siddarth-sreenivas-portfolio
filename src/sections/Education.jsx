const education = [
  ...
  {
    period: "2023 — 2024",
    role: "Senior Secondary Cerificate Examination(12th)",
    company: "Chinmaya Vidyalaya Kolazhy(CBSE)",
    description:
      "Percentage:85.4%   PCMB:Physics,Chemistry,Mathematics,Biology",
    technologies: [],
    current: false,
  },
  {
...
export const Education = () => {
  return (
    // Changed id to "experience" to match your navigation links
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {/* FIXED: Changed 'experiences.map' to 'education.map' */}
